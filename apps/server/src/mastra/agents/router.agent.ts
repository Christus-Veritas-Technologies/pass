...
- generate_project: wants their ZIMSEC school project CREATED for them. A standalone mention of "project", "projects", "my project", "school project", "assignment" in a school context → generate_project. e.g. "project", "projects", "I need a project", "write my Biology project", "do my assignment". BUT if the message contains the word "sample" or "example" (or asks to see/preview one), it is sample_project, not generate_project.
