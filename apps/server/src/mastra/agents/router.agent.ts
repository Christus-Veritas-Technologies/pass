...
export const routeSchema = z.object({
  kind: z
    .enum(["study_paper", "generate_project", "answer_question", "show_usage", "upgrade_plan"])
...
- generate_project: wants a ZIMSEC HBC project created. ANY standalone mention of "project", "projects", "HBC", "heritage project" or "assignment" in a school context → generate_project. e.g. "project", "projects", "I need a project", "write my Biology project", "do my assignment".
...
2. A bare "project" or "projects" is ALWAYS generate_project.
3. Extract subject/grade/year only if the student actually mentioned them; otherwise null.`;
